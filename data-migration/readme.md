...
Create a New Private S3 Bucket: Name the bucket devops-sync-23252.

Data Migration: Migrate the entire data from the existing devops-s3-6761 bucket to the new devops-sync-23252 bucket.
...
`aws s3 mb s3://devops-sync-23252`  
2. Migrate all files from the existing bucket to the newly created bucket  
`aws s3 sync s3://devops-s3-6761 s3://devops-sync-23252`